...
public class Quadtree {
	...
	public void subdivide() {
		Boundary nw = new Boundary(boundary.getX() - boundary.getWidth() / 2, 
									 boundary.getY() - boundary.getHeight() / 2,
									 boundary.getWidth() / 2, boundary.getHeight() / 2);
		northwest = new Quadtree(nw, capacity, depth - 1);
	
		Boundary ne = new Boundary(boundary.getX() + boundary.getWidth() / 2, 
									 boundary.getY() - boundary.getHeight() / 2,
									 boundary.getWidth() / 2, boundary.getHeight() / 2);
		northeast = new Quadtree(ne, capacity, depth - 1);
		
		Boundary sw = new Boundary(boundary.getX() - boundary.getWidth() / 2, 
				 					 boundary.getY() + boundary.getHeight() / 2,
				 					 boundary.getWidth() / 2, boundary.getHeight() / 2);
		southwest = new Quadtree(sw, capacity, depth - 1);
		
		Boundary se = new Boundary(boundary.getX() + boundary.getWidth() / 2, 
				 					 boundary.getY() + boundary.getHeight() / 2,
				 					 boundary.getWidth() / 2, boundary.getHeight() / 2);
